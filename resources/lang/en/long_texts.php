...
return [
    ...
    'notifications' => array(
      ...
      'watch_together' => "{{notification.data[0].user_name}} watched together with you. You can send movies to this user. If you want to know about this user, <a ng-href=\"recommendations/{{notification.data[0].user_id}}\" class=\"text-dark\">watch together</a> back.",
    )
];