...
return [
    ...
    'notifications' => array(
      ...
      'watch_together' => "<a ng-href=\"profile/{{notification.data[0].user_id}}\" class=\"text-dark\">{{notification.data[0].user_name}}</a> watched together with you. You can recommend movies and series to this user.",
    )
];