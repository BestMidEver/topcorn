				...
				<div id="collapseCover" class="collapse show" data-parent="#accordion">
					...
					<div class="custom-over-layer h-100 d-flex flex-column justify-content-between">
						...
						<div class="d-flex flex-row justify-content-center" ng-if="movie.videos.results.length > 0">
							<button class="btn btn-link text-white btn-lg" ng-click="isfragman=true;scroll_to_top()" data-toggle="collapse" data-target="#collapseFragman"><i class="far fa-play-circle mr-2"></i><small>{{ __('general.trailer') }}</small></button>
						</div>
					...
					<div class="d-flex flex-row background-black no-gutters">
						...
						<div class="col">
							<div class="h-100 d-flex flex-column justify-content-center text-center">
								<div>
									<button class="btn btn-outline-secondary border-0 btn-lg fa40 text-muted hover-white" ng-click="isfragman = false" data-toggle="collapse" data-target="#collapseCover"><i class="fa fa-angle-up"></i></button>
								</div>
							</div>
						</div>
