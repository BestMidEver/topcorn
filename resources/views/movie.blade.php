...
<div class="d-flex flex-wrap justify-content-between">
	<div>
		<div class="d-flex flex-column">
			<div class="px-3 px-md-0"><a class="text-dark" ng-href="http://www.google.com/search?q=@{{movie.title+' '+movie.release_date.substring(0, 4)}}" target="_blank"><h1 class="h4 pb-2 pt-3"
			@if(Auth::check())
...
<div class="container-fluid px-0 pt-5">
	<div class="h5 px-3 px-md-0">
		...
		<a href="/createlist/new" class="btn btn-outline-success btn-sm mt-2 mt-md-0" target="{{$target}}">
