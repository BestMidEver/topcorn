...
<div class="d-flex flex-wrap justify-content-between">
	...
	<div class="d-flex flex-column mt-1 mt-md-1 px-0 col-12 col-md-auto fa22 ml-auto">
		<div class="d-flex flex-row justify-content-between">
			...
			<a href="{{config('constants.facebook.share_website')}}" target="_blank" class="btn btn-outline-secondary btn-sm btn-block border-0 mt-0 px-lg-4 addfacebook"><i class="fas fa-share d-block text-center"></i>{{ __('general.share') }}</a>
		</div>
	</div>
	@endif
</div>
