...
<div class="d-flex flex-wrap justify-content-between">
	<div>
		<div class="d-flex flex-column">
			<div class="px-3 px-md-0"><a class="text-dark" ng-href="http://www.google.com/search?q=@{{movie.title+' '+movie.release_date.substring(0, 4)}}" target="_blank" data-toggle="tooltip" data-container="body" title="first tooltip"><h1 class="h4 py-2">@{{movie.title}}</h1></a></div>
		</div>
	</div>
	@if(Auth::check())
