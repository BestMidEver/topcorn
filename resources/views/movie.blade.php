...
<div class="d-flex flex-wrap justify-content-between">
	...
	<div class="d-flex flex-column mt-1 mt-md-1 px-0 col-12 col-md-auto fa22 ml-auto">
		<div class="d-flex flex-row justify-content-between">
			<button type="button" class="btn btn-outline-secondary btn-sm btn-block border-0 mt-0 px-lg-4 addlater" ng-class="{'text-black':user_movie_record.later_id!=null}" ng-click="this_later()"><i class="fa fa-clock-o d-block" aria-hidden="true"></i>{{ __('general.watch_later') }}</button>
