				...
				<div id="collapseCover" class="collapse show">
					...
					<div class="custom-over-layer h-100 d-flex flex-column justify-content-between">
						...
						<div class="d-flex flex-row justify-content-center" ng-if="movie.videos.results.length > 0">
							<button class="btn btn-link text-white btn-lg" ng-click="isfragman=true;scroll_to_top()" data-toggle="collapse" data-parent="#accordion" data-target="#collapseFragman" aria-expanded="false" aria-controls="collapseFragman"><i class="fas fa-play-circle mr-2" aria-hidden="true"></i><small>{{ __('general.trailer') }}</small></button>
						</div>
