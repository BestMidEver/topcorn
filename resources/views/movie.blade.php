...
<div class="d-flex flex-wrap justify-content-between">
	...
	<div class="d-flex flex-column mt-1 mt-md-1 px-0 col-12 col-md-auto fa22 ml-auto">
		<div class="d-flex flex-row justify-content-between">
			<button type="button" class="btn btn-outline-secondary btn-sm btn-block border-0 mt-0 px-lg-4 addlater" ng-class="{'text-warning':user_movie_record.later_id!=null}" ng-click="this_later()"><i class="fas fa-clock d-block pb-2" ng-if="user_movie_record.later_id!=null"></i><i class="far fa-clock d-block pb-2" ng-if="user_movie_record.later_id==null"></i>{{ __('general.watch_later') }}</button>
