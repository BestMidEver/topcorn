				...
				<div>
					<div id="@{{'collapse'+$index+'b'}}" data-parent="@{{'#accordion'+$index}}" class="lead lead-small collapse show">
						...
						<div class="d-flex justify-content-center">
							@if(Auth::check())
								@if(Auth::id()==7)
								<button class="btn btn-outline-secondary btn-sm border-0 mt-0 px-lg-4 addseen opacity-1 d-flex justify-content-center" ng-click="like_list()">
									<div><i class="fas fa-heart" ng-show="false"></i><i class="far fa-heart"></i> 12</div>
									likes
								</button>
								@endif
							@endif
							<div ng-if="review.id == 'long'" class="d-flex justify-content-center">
