			...
			<div class="col-12 col-lg-6">
				<div class="h-100 d-flex flex-column justify-content-center">
					<div>
						...
						<p class="text-center"><a class="btn btn-warning btn-lg" href="{{url('log_in/facebook')}}/false"><i class="fab fa-android text-left mr-4" aria-hidden="true"></i>{{ __('general.understand_my_taste') }}</a></p>
