			...
			<div class="col-12 col-lg-6">
				<div class="h-100 d-flex flex-column justify-content-center">
					<div>
						...
						<hr class="my-4">
						<p class="text-center"><a class="btn btn-info btn-lg d-flex align-items-center text-center" href="{{url('log_in/facebook')}}/false"><i class="fab fa-android text-left mr-4" aria-hidden="true"></i>{{ __('general.android_google_play_link') }}</a></p>
						<hr class="my-4">
						<p class="my-4 text-muted">{{ __('long_texts.home.t12') }}</p>
						<p class="text-center"><a class="btn btn-warning btn-lg d-flex align-items-center text-center" href="{{url('log_in/facebook')}}/false"><i class="fab fa-facebook-square text-left mr-4" aria-hidden="true"></i>{{ __('general.understand_my_taste') }}</a></p>
