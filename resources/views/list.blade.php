		...
		<div class="container-fluid mt-3">
				...
				<div class="col-12">
					<div class="card h-100">
						<div class="d-flex flex-wrap justify-content-between">
							<div class="p-1">
								<a ng-href="/movie/@{{movie.id}}" ng-attr-id="movie-@{{movie.id}}" data-toggle="tooltip" data-placement="top" title="@{{movie.original_title}}" target={{$target}}>
							...
							<div class="row no-gutters pt-3 pt-md-2">
								<div class="col-4 col-md-3 col-xl-2">
									<a ng-href="/movie/@{{movie.id}}" ng-mouseover="show_tooltip('movie-'+movie.id)" ng-mouseleave="hide_tooltip('movie-'+movie.id)()" target={{$target}}>
			...
			<div class="mt-5 d-flex flex-row justify-content-between">
				...
				<div class="d-flex flex-column mt-3 ml-1 fa22">
					<div class="d-flex flex-row">
						<button class="btn btn-outline-secondary btn-sm btn-block border-0 mt-0 px-lg-4 addseen opacity-1 background-inherit" ng-class="{'text-success':is_liked}" ng-click="like_list()" ng-disabled="{{(Auth::check()==0 || $liste[0]->user_id==Auth::id())?'true':'false'}}">
