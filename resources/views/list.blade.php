...
<div class="row no-gutters">
	<div class="mt-5 col-12 col-xl-6">
		...
		<div class="row no-gutters pt-2">
			...
			<div class="col-8 lead lead-small"><span class="pl-2">Amerika'nın en uyduruk havayollarından birinde hava hostesi olan Jackie Brown'ın emekliliği giderek yaklaşmaktadır. Hostesimiz ayın sonunu getirebilmek için silah kaçakçısı Ordell için çalışmaktadır. Polis durumdan haberdardır. Ordell de polisin haberdar olduğundan ve dolayısıyla Jackie'nin hayatının bıçak sırtında olduğundan.Olaylar ortaya çıktığuında Jackie ve Ordell cephelerine yeni yardımcılar katılır ve herkes yarım milyon doların peşine düşer.Yönetmen Tarantino, hayranı olduğu, 70'li yılların kült zenci dizisi "Foxy Brown"ın kadın oyuncusu Palm Grier'e Jackie Brown rolünü vererek tam onikiden vuruyor.</span></div>
		</div>
	</div>
	<div class="mt-5 col-12 col-xl-6">
	...
	<div class="mt-5 col-12 col-xl-6">
		...
		<div class="row no-gutters pt-2">
			...
			<div class="col-8 lead lead-small"><span class="pl-2">Alkol sorunları yüzünden herşeyini kaybetmiş olan Hollywood senaristi Ben Sanderson ( Cage) ölümüne içmek için Las Vegas'a gelir. Burada tesadüfen tanışacağı hayat kadını Sera ( Shue ) ile aşka dönüşen ilişkisi ise artık hayata farklı bir açıdan bakmasına sebep olacaktır</span></div>
		</div>
