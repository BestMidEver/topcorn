		...
		<div class="container-fluid mt-3">
			...
			<div class="mt-5 d-flex flex-row justify-content-between">
				...
				<div class="d-flex flex-column mt-3 ml-1 fa22">
					<div class="d-flex flex-row">
						<button class="btn btn-outline-secondary btn-sm btn-block border-0 mt-0 px-lg-4 addseen" ng-class="{'text-success':is_liked}" ng-click="like_list()" ng-disabled="{{Auth::check()==1?'false':'true'}}">
