				...
				<div class="d-flex flex-wrap justify-content-between">
					...
					<div class="d-flex flex-column mt-1 mt-md-1 px-0 col-12 col-md-auto fa22 ml-auto">
						<div class="d-flex flex-row justify-content-between text-center">
							...
							<button type="button" class="btn btn-sm btn-block border-0 mt-0 px-lg-4 addseen" ng-class="rate_class(1)" ng-click="votemodal($index, movie)"><div><span ng-show="!movie.rate_code>0"><i class="far fa-star"></i></span><span ng-show="movie.rate_code>0"><i class="fas fa-check"></i></span></div></button>
