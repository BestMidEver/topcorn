				...
				<a href="/profile/{{ $liste[0]->user_id }}" class="text-no-decoration">
					<div class="d-flex flex-row">
						...
						<div class="d-flex flex-column justify-content-center ml-2">
							...
							<div class="text-muted"><small class="text-no-decoration">{{ $liste[0]->created_at->diffForHumans() }} ay önce ekledi, en son {{ $liste[0]->updated_at }} gün önce güncelledi.</small></div>
						</div>
					</div>
				</a>
			</div>
