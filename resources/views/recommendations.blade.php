...
<div class="col mb-2 mt-3 mt-md-4">
	...
	<div class="d-inline" ng-show="active_tab!='mood_pick'">
		...
		<button id="addperson_button" class="btn btn-outline-secondary my-2 border-circle btn-lg" type="button" data-toggle="collapse" data-target="#collapseAdd" ng-click="setFocus('input_user')"><small><i class="fas fa-user-plus"></i></small></button>
	</div>
	@endif
	<div class="d-inline" ng-show="active_tab=='mood_pick'">
