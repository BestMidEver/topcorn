...
<div class="col mt-1 mb-2 mt-md-4">
	...
	<div class="d-inline ml-3" ng-show="active_tab=='mood_pick'">
		...
		<button class="btn btn-outline-warning btn-sm my-2 hover-white" type="button" data-toggle="collapse" data-target="#collapseAdd" ng-click="setFocus('input_mode')"><i class="fas fa-plus"></i> <span ng-show="mode_movies.length == 0">{{ __('general.pick_mode') }}</span><span ng-hide="mode_movies.length == 0"> {{ __('general.add_movie') }}</span></button>
	</div>
</div>
<!-- H1 +AddPerson +AddMode row  -->
