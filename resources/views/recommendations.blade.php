...
<div class="container-fluid mt-3 pb-1" id="filter">
	<ul class="nav justify-content-md-center tab1">
		...
		<li class="nav-item ml-3 pb-2">
			<button class="nav-link btn btn-outline-secondary btn-sm" ng-click="drawslider();scroll_to_filter();is_filter_collapsed()" type="button" data-toggle="collapse" data-target="#collapseFilter" ng-disabled="{{ auth::check()?'false':'true' }} && active_tab=='top_rated'"><i class="fa fa-filter"></i> {{ __('general.filter') }}</button>
		</li>
	</ul>
</div>
<!-- Tabs and Filter Button -->
