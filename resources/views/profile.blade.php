...
<!-- Tabs Button -->
<div class="container-fluid mt-3 d-none d-md-inline mt-3 mx-auto">
	<div class="btn-group" role="group" aria-label="Movies or Series" ng-init="page_variables.movies_or_series = 'movies'">
