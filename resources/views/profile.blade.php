...
<div class="position-relative mt-md-4">
	...
	<div class="right-top">
		...
		<a class="btn btn-link mt-2 mr-2 text-muted" href="/account"><i class="fa fa-cog" aria-hidden="true"></i> {{ __('navbar.account') }}</a>
		@else
		<a class="btn btn-link mt-2 mr-2 text-muted" href="/recommendations/{{$profile_user_id}}"><i class="fa fa-plus" aria-hidden="true"></i> {{ __('general.watch_together') }}</a>
		@endif
	</div>
	@endif
</div>
