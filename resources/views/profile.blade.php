...
<div class="container-fluid mt-3 d-none d-md-inline">
	<ul class="nav justify-content-md-center tab1">
		...
		<li class="nav-item" ng-if="!page_variables.is_guest">
...
<div class="scrollmenu mt-3 d-md-none tab2">
	...
	<button class="btn btn-link border-no-radius text-sm-center text-muted text-no-decoration" ng-class="{'active':active_tab=='get_bans'}" ng-if="!page_variables.is_guest" ng-click="active_tab='get_bans';get_first_page_data();">{{ __('general.banneds') }}</button>
