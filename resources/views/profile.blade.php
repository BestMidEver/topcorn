...
<div class="d-flex flex-wrap justify-content-between">
	<div class="d-flex flex-column mt-1 mt-md-1 px-0 col-12 col-md-auto fa22 ml-auto">
		<div class="d-flex flex-row justify-content-between text-center">
			@if($profile_user_id != Auth::user()->id)
			<a class="btn btn-outline-secondary btn-sm btn-block border-0 mt-0 px-lg-4 addban" href="/recommendations/{{$profile_user_id}}"><div><i class="fa fa-plus"></i></div><span class="scrollmenu">{{ __('general.watch_together') }}</span></a>
			<button type="button" class="btn btn-outline-secondary btn-sm btn-block border-0 mt-0 px-lg-4 addban" ng-class="{'text-success':page_variables.follow_id != -1}" ng-click="toggle_follow()" ng-mouseenter="hovering_fol=true" ng-mouseleave="hovering_fol=false">
...
<div class="container-fluid d-none d-md-inline no-gutters mt-5">
	<ul class="nav justify-content-md-center tab1">
		...
		<li class="nav-item">
			<button class="btn btn-link nav-link text-muted" ng-class="{'active':active_tab=='get_reviews'}" ng-click="active_tab='get_reviews';get_first_page_data();">{{ __('general.reviews') }}</button>
		</li>
		<li class="nav-item">
			<button class="btn btn-link nav-link text-muted" ng-class="{'active':active_tab=='get_follows'}" ng-click="active_tab='get_follows';follows_mode='following';get_first_page_data();">{{ __('general.follows') }}</button>
		</li>
	</ul>
</div>
<!-- Tabs Button -->
...
<div class="scrollmenu d-md-none tab2 no-gutters mt-3">
	...
	<button class="btn btn-link border-no-radius text-sm-center text-muted text-no-decoration" ng-class="{'active':active_tab=='get_reviews'}" ng-click="active_tab='get_reviews';get_first_page_data();">{{ __('general.follows') }}</button>
