...
<div class="mt-3">
    <div ng-repeat="notification in page_variables.notifications">
        <div class="d-flex py-2 pl-2 align-items-center background-lightgrey">
            <div class="flex-grow-1" ng-if="notification.data[0].mode==0 || notification.data[0].mode==1">
            ...
            <div class="ml-2">
                <button class="btn addban"><i class="fa-circle" ng-class="notification.data[0].is_seen?'fas':'far'"></i></button>
            </div>
        </div>
        <hr class="m-0">
    </div>
