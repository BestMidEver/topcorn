...
<div class="mt-3">
    <div ng-repeat="notification in page_variables.notifications">
        <div class="d-flex py-2 pl-2 align-items-center background-lightgrey">
            <div class="flex-grow-1" ng-if="notification.mode==0 || notification.mode==1">
            ...
            <div class="ml-2">
                <button class="btn addban"><i class="fa-circle" ng-class="notification.is_seen?'fas':'far'"></i></button>
            </div>
        </div>
        <hr class="m-0">
    </div>
