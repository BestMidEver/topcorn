...
<div class="mt-4" ng-show="page_variables.expanded==-1 || page_variables.expanded==1" id="scroll_to_top1">
	...
	<div class="container-fluid" ng-show="is_expanded1">
		<div class="btn-group mr-2 mt-3">
			<button type="button" class="btn btn-outline-secondary btn-sm" ng-class="page_variables.f_following1=='all'?'active':''" ng-click="page_variables.f_following1='all';get_first_page_data(1);">All Votes</button>
