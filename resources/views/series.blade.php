        ...
        <div id="accordion">
            <div>
                <div id="collapseCover" class="collapse show" data-parent="#accordion">
                    <img src="https://image.tmdb.org/t/p/w1280/gX8SYlnL9ZznfZwEH4KJUePBFUM.jpg" on-error-src="" class="img-fluid trailercover" alt="Responsive image">
                    <div class="custom-over-layer h-100 d-flex flex-column justify-content-between">
                        <div class="d-flex flex-row no-gutters">
                            <div class="col pt-2 pl-2">
                                ...
                                <div class="text-white h6 lead lead-small">Last Seen Episode: S02E11</div>
                            </div>
            ...
            <div>
                <div id="collapseFragman" class="collapse" data-parent="#accordion" ng-if="movie.videos.results.length > 0">
                    ...
                    <div class="embed-responsive embed-responsive-1by1 trailer">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/2c3VVJb562Y" allowfullscreen></iframe>
                    </div>
...
<div class="row no-gutters mt-3 mt-md-5 mb-md-5">
    <div class="col-12 col-md-3 col-lg-3">
        <img src="https://image.tmdb.org/t/p/w300_and_h450_bestv2/gwPSoYUHAKmdyVywgLpKKA4BjRr.jpg" on-error-src="" class="card-img-top d-none d-md-inline" alt="Responsive image">
    </div>
    ...
    <div class="col-9 col-lg-3">
        <div class="container-fluid">
            ...
            <div>
                <div class="h6 pt-1">Origin Country</div>
