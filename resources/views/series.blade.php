...
<div class="d-flex flex-wrap justify-content-between">
    ...
    <div class="d-flex flex-column mt-1 mt-md-1 px-0 col-12 col-md-auto fa22 ml-auto pb-5">
        <div class="d-flex flex-row justify-content-between text-center">
            ...
            <button type="button" class="btn btn-sm btn-block border-0 mt-0 px-lg-4 addseen" ng-class="rate_class(user_movie_record.rate_code)" ng-click="this_votemodal()"><div><span><i class="fas fa-check"></i></span></div>Seen</button>
