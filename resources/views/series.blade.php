                            ...
                            <div class="h-100 d-flex flex-column justify-content-center pl-2">
                                <div ng-if="series.videos.results.length > 1">
                                    ...
                                    <div class="dropdown d-inline">
                                      <button class="btn btn-outline-secondary border-0 btn-lg text-muted hover-white dropdown-toggle" type="button" id="dropdownchoosetrailer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
