...
<div class="container-fluid p-0 d-none d-md-inline" ng-if="page_variables.active_tab_1!=-1">
    <ul class="nav justify-content-md-center tab1">
        ...
        <li class="nav-item" ng-repeat="episode in series.episodes">
            <button class="btn btn-link nav-link" ng-class="{'active':page_variables.active_tab_2==episode.episode_number,'text-primary font-weight-bold':(season.season_number==page_variables.last_seen_season && episode.episode_number==page_variables.last_seen_episode), 'text-muted':episode.episode_number!=page_variables.last_seen_episode}" ng-click="page_variables.active_tab_2=episode.episode_number;pull_data()"><span>@{{season.season_number}}@{{page_variables.last_seen_season}}sE@{{episode.episode_number>9?episode.episode_number:'0'+episode.episode_number}}</span></button>
        </li>
    </ul>
</div>
<!-- Tabs_2 Button -->
