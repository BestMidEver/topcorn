                ...
                <div id="collapseCover" class="collapse show" data-parent="#accordion">
                    ...
                    <div class="custom-over-layer h-100 d-flex flex-column justify-content-between">
                        ...
                        <div class="d-flex flex-row justify-content-between p-2">
                            <div class="d-flex flex-column justify-content-end"><img ng-src="{{config('constants.image.svg')}}@{{page_variables.network_logo}}" on-error-src="" class="network-logo" alt=""></div>
