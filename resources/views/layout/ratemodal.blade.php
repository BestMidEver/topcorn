				...
				<div class="card-img-overlay p-2">
					<div class="text-center h-100 d-flex flex-column justify-content-between">
						...
						<div class="d-flex flex-row justify-content-between align-items-end">
							...
							<div class="faderdiv">
								<button type="button" class="btn btn-lg float-left border-circle dark-background" ng-class="modalmovie.ban_id!=null ? 'text-danger' : 'text-white'" ng-show="modalmovie.is_quick_rate" ng-click="modalmovie.is_quick_rate ? quick_ban() : ban(modalmovie.index)">
