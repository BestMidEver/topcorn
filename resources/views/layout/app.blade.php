...
<body>
    ...
    ?>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark px-md-0 z-1041" ng-init="start_course='{{ __('navbar.start_course') }}';graduate='{{ __('navbar.graduate') }}'">
        <div class="container{{ $full_screen }}">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <button class="nav-link d-md-none text-warning btn btn-link" ng-click="quickvote()"><i class="fas fa-star-half" aria-hidden="true"></i><span class="d-none d-sm-inline"> {{ __('navbar.sequentialvote') }}</span></button>
                </li>
            </ul>
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"
                            ...
                            @endif
                        >
                        <button class="nav-link text-warning btn btn-link" ng-click="quickvote()"><i class="fas fa-star-half d-none d-md-inline" aria-hidden="true"></i> {{ __('navbar.sequentialvote') }}</button>
