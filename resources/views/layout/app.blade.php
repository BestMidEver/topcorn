...
<body class="{{$theme}}">
    ...
    <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-night px-md-0 py-md-0 z-1041" ng-init="start_course='{{ __('navbar.start_course') }}';graduate='{{ __('navbar.graduate') }}'" ng-cloak>
        ...
        <div class="container pt-5">
            <div class="row text-center text-sm-left">
                ...
                <div class="col col-sm-3 d-none d-sm-inline">
                    ...
                    <div class="py-2 small"><a class="text-dark" href="/notifications">{{ __('navbar.notifications') }}</a></div>
                ...
                <div class="col-8 col-sm-4 text-sm-right">
                    <div class="h-100 d-flex flex-column justify-content-between">
                        <div class="py-2 small">
                            ...
                            <a class="btn btn-link btn-sm fa40 text-muted" href="{{config('constants.instagram.our_link')}}" target="_blank" data-toggle="tooltip" data-placement="top" title="{{ __('general.users_instagram') }}">Android Application <i class="fab fa-instagram"></i></a>
