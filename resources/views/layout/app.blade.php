        ...
        <div class="container{{ $full_screen }}">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav ml-auto d-none d-md-flex">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ (Request::segment(1) === 'notifications') ? 'active' : null }}" href="/notifications"><i class="far fa-bell"></i><span class="badge badge-danger ml-1">{{App\Model\Notification::get_notification_button()}}</span></a>
                    </li>
                    <li class="nav-item"
                            @if(Auth::User()->tt_navbar < 50)
