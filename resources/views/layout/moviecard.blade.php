				...
				<div class="position-relative text-center min-height-200">
					...
					<div class="custom-over-layer h-50 d-flex flex-column justify-content-center">
						...
						<div class="d-flex flex-row justify-content-center" ng-if="!isNaN(movie.day_difference_last)">
							<div class="text-white" ng-if="(movie.day_difference_last<1 || !movie.last_episode_air_date.length>0) && movie.last_seen_air_date.length>0 && movie.status=='Returning Series'">
							...
							<span ng-if="movie.status=='Ended'" class="h5 text-warning">{{ __('general.ended') }}</span>
							<span ng-if="movie.status=='Canceled'" class="h5 text-warning">{{ __('general.canceled') }}</span>
							<div class="text-white" ng-if="movie.day_difference_last>0">
								...
								<span class="d-block"><span class="h5 text-warning">
									...
									<span ng-if="movie.day_difference_last>1">{{ __('general.available') }}</span>
								</span>
							</div>
