		...
		<div class="card moviecard h-100 d-flex flex-column justify-content-between mx-sm-2">
			...
			<div class="card-footer p-0">
				<div class="row no-gutters">
					<div class="col">
						<button type="button" class="btn btn-outline-secondary btn-sm btn-block addlater border-0" ng-class="{'text-black':movie.later_id!=null}" ng-click="later($index)"><i class="fa fa-clock-o" aria-hidden="true"></i></button>
					</div>
					<div class="col-7">
