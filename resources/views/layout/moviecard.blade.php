		...
		<div class="card moviecard h-100 d-flex flex-column justify-content-between mx-sm-2">
			...
			<div class="card-footer p-0">
				<div class="row no-gutters">
					<div class="col">
						<button type="button" class="btn btn-outline-secondary btn-sm btn-block addlater border-0" ng-class="{'text-warning':movie.later_id!=null}" ng-click="later($index)" data-toggle="tooltip" data-placement="bottom" data-original-title="@{{movie.later_id!=null ? 'Sonra İzle\'mden çıkart.' : 'Sonra İzle\'me ekle.'}}"><i class="fa fa-clock-o" aria-hidden="true"></i></button>
					</div>
					<div class="col-7">
