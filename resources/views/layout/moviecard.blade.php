		...
		<div class="card moviecard h-100 d-flex flex-column justify-content-between mx-2">
			...
			<div class="card-footer p-0">
				<div class="row no-gutters">
					...
					<div class="col">
						<button type="button" class="btn btn-outline-secondary btn-sm btn-block addban border-0" ng-class="{'text-danger':movie.ban_id!=null}" ng-click="ban($index)" data-toggle="tooltip" data-placement="bottom" title="{{ __('general.tooltip_ban') }}"><i class="far fa-clock"></i></button>
					</div>
				</div>
			</div>
			@endif
