	...
	<div class="container-fluid">
		<div ng-if="page_variables.reviews.length>0" class="py-4" ng-repeat="review in page_variables.reviews" ng-hide="review.content==''">
			<div class="d-flex justify-content-between">
				...
				<div class="d-inline" ng-if="review.name.length>0"><a class="h6 pb-2 text-dark d-inline" ng-href="/profile/@{{review.user_id}}">@{{review.name}}</a> <span ng-repeat="n in [] | range:review.rate"><i class="far fa-star"></i><span ng-repeat="n in [] | range:(5-review.rate)"><i class="fas fa-star"></i></span></div>
				<div class="h6">
