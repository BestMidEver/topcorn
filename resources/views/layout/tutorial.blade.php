      ...
      <div class="modal-body">
        <ul class="list-group">
          ...
          <li class="list-group-item list-group-item-success">
            ...
            <span class="lead py-2">"İzlemedim"</span> -> İzlemediğin filmler için
            <span class="lead py-2">"Sakın"</span> -> İzlediğine çok pişman olduğun ve kesinlikle senin için zaman kaybı olduğunu düşündüğün filmler için
            <span class="lead py-2">"Önerme"</span> -> İzlemeseydim de olurdu dediğin filmler için
            <span class="lead py-2">"Kararsız"</span> -> İyi hatırlayamadığın, olumlu ya da olumsuz bir fikrinin olmadığı filmler için
            <span class="lead py-2">"Öner"</span> -> Beğendiğin filmler için
            <span class="lead py-2">"Kesinlikle"</span> -> Kesinlikle, ne olursa olsun izlenmesi gereken filmler için
          </li>
          <li class="list-group-item list-group-item-success">
