	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body scrollable-modal-body">
				<div class="btn-group-toggle mb-1" ng-class="f_send_user[user.user_id]?'btn-tab':'btn-outline-secondary'" ng-repeat="user in page_variables.watch_togethers">
					<label class="btn btn-block border-0 btn-tab">
						<input type="checkbox" ng-model="f_send_user[user.user_id]"> @{{user.user_name}}
					</label>
				</div>
			</div>
