		...
		<div class="modal-content">
			...
			<div class="modal-body scrollable-modal-body">
				<div class="btn-group-toggle">
					<label class="btn btn-block border-0 btn-tab mb-1" ng-class="page_variables.f_send_user[user.user_id]===true?'btn-tab':'btn-outline-secondary'" ng-repeat="user in page_variables.watch_togethers">
