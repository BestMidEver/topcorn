<div class="pt-2">
	<button id="languages_button" class="btn btn-lg btn-outline-secondary background-inherit dropdown-toggle h6 m-0 border-0" type="button" data-toggle="collapse" data-target="#collapseLanguages"><span class="h6">{{ __('general.language') }}</span></button>
