<div class="">
	...
	<div class="">
		<div class="" >
			<!--<label class="form-check-label nowrap">col-6 col-sm-4 col-md-3 col-lg-2 d-flex flex-wrap
			...
			<div class="btn-group-toggle row" data-toggle="buttons" ng-repeat="language in languages">
				<label class="btn col btn-outline-secondary m-1 border-0">
