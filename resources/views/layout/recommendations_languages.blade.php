<div class="">
	<p class=""><button id="languages_button" class="btn btn-outline-secondary btn-sm dropdown-toggle h6 text-muted pt-3" type="button" data-toggle="collapse" data-target="#collapseLanguages">{{ __('general.language') }} </button></p>
