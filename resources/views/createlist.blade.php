						...
						<div class="row no-gutters mt-3">
							...
							<div class="input-group col">
								...
								<div ng-show="(search_1 || choosing_1) && movies_1.length > 0" class="search-movie-results background-white py-3" ng-mouseenter="choosing_1=true" ng-mouseleave="choosing_1=false">
									<div class="result py-1" ng-repeat="movie in movies_1" ng-click="choose_movie(1)">@{{movie.title}} <small ng-if="movie.release_date.length > 0"><em>(@{{movie.release_date.substring(0, 4)}})</em></small></div>
								</div>
							</div>
						</div>
						<div class="row no-gutters mt-3">
