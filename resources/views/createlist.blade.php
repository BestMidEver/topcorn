					...
					<div class="card h-100 p-2 col-12">
						...
						<div class="row no-gutters mt-3">
							...
							<div class="input-group col">
								...
								<input ng-attr-id="vitrin_@{{$index}}" dynamic-show="'!searchmode_'+$index" type="text" class="form-control" ng-click="searchmode_1=true;set_focus(1)" dynamic-model="'title_chosen_'+$index" placeholder="Filmin adını giriniz.">
