						...
						<div class="row no-gutters mt-3">
							...
							<div class="input-group col mt-3 mt-md-0">
								<div class="input-group-prepend pl-md-3">
									<button class="btn btn-outline-secondary" ng-class="{'active':movie.mode==0}" ng-click="movie.mode=0;search_movie(movie)" type="button">Movies</button>
									<button class="btn btn-outline-secondary" ng-class="{'active':movie.mode!=0}" ng-click="movie.mode=1;search_movie(movie)" type="button">Series</button>
								</div>
