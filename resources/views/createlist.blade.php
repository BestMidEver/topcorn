						...
						<div class="row no-gutters mt-3">
							...
							<div class="input-group col">
								...
								<div ng-show="search_1" class="search-movie-results background-white py-3">
									<div class="result" ng-repeat="movie in movies_1">@{{movie.title}} <small class="text-muted" ng-if="movie.release_date.length > 0"><em>(@{{movie.release_date.substring(0, 4)}})</em></small></div>
								</div>
							</div>
						</div>
						<div class="row no-gutters mt-3">
