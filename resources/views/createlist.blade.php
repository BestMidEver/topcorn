					...
					<div class="card h-100 p-2 col-12">
						...
						<div class="row no-gutters mt-3">
							...
							<div class="input-group col-12 col-md-4 col-xl-3">
								...
								<input type="number" name="items[item_@{{$index}}[position]]" ng-model="l.position" class="form-control">
							</div>
							<!-- Order number -->
							...
							<div class="input-group col mt-3 mt-md-0">
								...
								<input ng-attr-id="movie_id_@{{$index}}" ng-show="false" type="text" class="form-control" ng-model="l.movie_id" name="items[item_@{{$index}}[movie_id]]">
						...
						<div class="row no-gutters mt-3" ng-if="l.movie_title.length>0">
							...
							<div class="input-group col pl-3">
								...
								<textarea class="form-control" aria-label="With textarea" placeholder="@{{l.overview}}" name="items[item_@{{$index}}[explanation]]"></textarea>
							</div>
						</div>
					</div>
				</div>
