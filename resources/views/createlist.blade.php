					...
					<div class="col-md-9">
						<div class="">
							<div class="input-group mb-2 mr-sm-2 mb-sm-0">
								...
								<input type="text" class="form-control" id="header" name="header" value="{{ count($liste) > 0 ? $liste[0]->title : '' }}" required autofocus>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="">
							<div class="input-group mb-2 mr-sm-2 mb-sm-0">
								...
								<textarea type="text" class="form-control" id="entry_1" name="entry_1">{{ count($liste) > 0 ? $liste[0]->entry_1 : '' }}</textarea>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="">
							<div class="input-group mb-2 mr-sm-2 mb-sm-0">
								...
								<textarea type="text" class="form-control" id="entry_2" name="entry_2">{{ count($liste) > 0 ? $liste[0]->entry_2 : '' }}</textarea>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="form-group">
							<div class="input-group mb-2 mr-sm-2 mb-sm-0">
								...
								<select class="form-control" id="visibility" name="visibility">
									<option value="1" {{ count($liste) > 0 ? ($liste[0]->visibility == 1 ? 'selected' : '') : 'selected' }}>Herkes</option>
									<option value="0" {{ count($liste) > 0 ? ($liste[0]->visibility == 0 ? 'selected' : '') : '' }}>Sadece Ben</option>
								</select>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							<div class="input-group mb-2 mr-sm-2 mb-sm-0">
								...
								<select class="form-control" id="sort_by" name="sort_by">
									<option value="2" {{ count($liste) > 0 ? ($liste[0]->sort == 2 ? 'selected' : '') : 'selected' }}>Büyükten Küçüğe</option>
									<option value="1" {{ count($liste) > 0 ? ($liste[0]->sort == 1 ? 'selected' : '') : '' }}>Küçükten Büyüğe</option>
									<option value="0" {{ count($liste) > 0 ? ($liste[0]->sort == 0 ? 'selected' : '') : '' }}>Devre Dışı</option>
								</select>
							</div>
						</div>
					</div>
