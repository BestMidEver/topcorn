					...
					<div class="col-md-9">
						<div class="">
							<div class="input-group mb-2 mr-sm-2 mb-sm-0">
								...
								<textarea type="text" class="form-control" id="entry_1" name="entry_1"  oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"'>{{ $liste != '[]' ? $liste[0]->entry_1 : '' }}</textarea>
							</div>
						</div>
					</div>
				</div>
