...
@section('og_tags')
<meta property="og:image" content="{{config('constants.image.fb_http')}}{{$poster_path}}"/>
<meta property="og:image:secure_url" content="{{config('constants.image.fb_https')}}{{$poster_path}}"/>
@endsection