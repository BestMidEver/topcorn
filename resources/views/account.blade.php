...
<div class="position-relative pt-1">
	...
	<div class="right-bottom pr-2 fa30">
		<a class="btn btn-link mb-2 text-light btn-sm" ng-show="another_link_name" href="#" target="_blank"><span class="h6">@{{another_link_name || (another_link_name==0) ? another_link_name : {{ '"'.__('general.personal_website').'"' }}}}</span></a>
