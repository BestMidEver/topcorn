...
<div class="position-relative pt-1">
	...
	<div class="right-bottom pr-2 fa30">
		<a class="btn btn-link mb-2 text-light btn-sm" ng-if="another_link_name" href="#"><span class="h6">Personal Website</span></a>
		<a class="btn btn-link mb-2 text-light btn-sm" ng-if="facebook_link" href="#"><i class="fab fa-facebook-square"></i></a>
		<a class="btn btn-link mb-2 text-light btn-sm" ng-if="instagram_link" href="#"><i class="fab fa-instagram"></i></a>
		<a class="btn btn-link mb-2 text-light btn-sm" ng-if="twitter_link" href="#"><i class="fab fa-twitter-square"></i></a>
		<a class="btn btn-link mb-2 text-light btn-sm" ng-if="youtube_link" href="#"><i class="fab fa-youtube-square"></i></a>
	</div>
</div>
