...
///////////////////////////////////// MOVIE PAGE (PULBIC) ////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////
Route::get('movie/{id}/{lang?}/{secondary_lang?}', 'PageControllers\movieController@movie')->middleware('id_dash_moviename')->middleware('LastSeen')
	->where('lang', config('constants.supported_languages.for_web_php'));
...
Route::get('test', function(){
    ...
    foreach ($items as $item) {
        echo $item->user_id.' - '.$item->when_automatic_notification.'<br>';
    }
    return 'finish';
	$output = shell_exec('python py/hello.py 2>&1');
	return $output;
});
//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////// TEST ////////////////////////////////////////
