...
class movieController extends Controller
{
    public function movie($id, $lang = '', $secondary_lang='')
    {
        ...
        $amazon_variables = amazon_affiliate();

    	return view('movie', compact('id', 'id_dash_title', 'image_quality', 'target', 'watched_movie_number', 'movie_title', 'movie_en_title', 'random_int', 'movie_plot', 'movie_year', 'poster_path', 'amazon_variables'))->with('watch_togethers', $watch_togethers);
    }
