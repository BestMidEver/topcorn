...
class accountController extends Controller
{
	...
	public function account($lang = '')
	{
        ...
        $url_http = count($exploded_url) > 1 ? $exploded_url[0].'://' : 'https://';
	...
	public function change_profile(Request $request)
	{
		...
		$user->another_link_url = $request->another_link_url && $request->another_link_url != 'https://' ? $request->url_http.$request->another_link_url : null;
		$user->save();
