    ...
    public function handle()
    {
        ...
        if($this->isWithRecommendation){
            ...
            Serie::updateOrCreate(
                ...
                'first_air_date' => new Carbon($series['first_air_date']),
                'next_episode_air_date' => new Carbon($series['next_episode_to_air']['air_date']),
                'last_episode_air_date' => new Carbon($series['last_air_date']),
