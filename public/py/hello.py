...
df = pd.read_sql("""
	SELECT rateds.user_id, rateds.movie_id, rateds.rate, movies.vote_count, movies.vote_average, movies.popularity
	FROM rateds
	INNER JOIN
...
model = MLPClassifier(hidden_layer_sizes=(8,100,8))#,max_iter=250)
